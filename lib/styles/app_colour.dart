...
class AppColour {
  AppColour._();
  static final _storage = getIt<LocalStorage>();
  static bool _isDarkMode =
      _storage.getCachedData<bool>(StorageKey.darkModeSetting) ?? false;
  ...
  static const Color _lightTextFieldBackground = Color(0xFFFFFFFF);
  static const Color _lightTextFieldBorder = Color(0xFFD1D5DB);
  static const Color _lightTextFieldFocusedBorder = Color(0xFF3B82F6);
  static const Color _lightTextFieldErrorBorder = Color(0xFFEF4444);
  static const Color _lightTextFieldText = Color(0xFF374151);
  static const Color _lightTextFieldHint = Color(0xFF9CA3AF);
  static const Color _lightTextFieldLabel = Color(0xFF6B7280);
  static const Color _lightDisabled = Color(0xFF9CA3AF);
  static const Color _lightOnDisabled = Color(0xFF6B7280);
  ...
  static const Color _darkOnSecondary = Color(0xFF4C1D95);
  ...
  static const Color _darkTextFieldBorder = Color(0xFF6B7280);
  static const Color _darkTextFieldFocusedBorder = Color(0xFF3B82F6);
  static const Color _darkTextFieldErrorBorder = Color(0xFFF87171);
  static const Color _darkTextFieldText = Color(0xFFF8FAFC);
  static const Color _darkTextFieldHint = Color(0xFF9CA3AF);
  ...
  static Color get cardBorder => _getColour(_lightCardBorder, _darkCardBorder);

  // Text field colours
  static Color get textFieldBackground =>
      _getColour(_lightTextFieldBackground, _darkTextFieldBackground);
  static Color get textFieldBorder =>
      _getColour(_lightTextFieldBorder, _darkTextFieldBorder);
  static Color get textFieldFocusedBorder =>
      _getColour(_lightTextFieldFocusedBorder, _darkTextFieldFocusedBorder);
  static Color get textFieldErrorBorder =>
      _getColour(_lightTextFieldErrorBorder, _darkTextFieldErrorBorder);
  static Color get textFieldText =>
      _getColour(_lightTextFieldText, _darkTextFieldText);
  static Color get textFieldHint =>
      _getColour(_lightTextFieldHint, _darkTextFieldHint);
  static Color get textFieldLabel =>
      _getColour(_lightTextFieldLabel, _darkTextFieldLabel);
